"""Merge small JSON/JSONL work packets into one value-expression ledger."""
...
LEDGERS = {
    "existing_expressions": ("existing_expression_ledger.jsonl", "expression_id", ("EX-", "PEX-")),
    "six_path": ("six_path_ledger.jsonl", "scan_id", ("PATH-",)),
    "slots": ("slot_scan_ledger.jsonl", "slot_id", ("SLOT-",)),
    "vis": ("vis_ledger.jsonl", "vis_id", ("VIS-",)),
    "validation": ("validation_ledger.jsonl", "test_id", ("TEST-",)),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Merge value-expression ledger partitions.")
