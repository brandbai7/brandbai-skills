...
def build_plan(
    ...
    return {
        ...
        "will_create": [*reports, *(f"data/{name}" for name in (
            ...
            "content_decision_match_ledger.jsonl", "decision_ledger.jsonl", "action_ledger.jsonl",
    ...
    try:
        ...
        write_json(
            data / "page_chain.json",
            {
                "schema_version": SCHEMA_VERSION,
                "analysis_target": {
                    "analysis_sku": identity["sku"],
                    "target_basis": "unknown",
                    "page_primary_sku_or_variant": "",
                    "visible_option_match_status": "not_provided",
                    "visible_option_evidence": "",
                    "dynamic_snapshot_applicability": "unknown",
                    "decision": "stopped",
                    "boundary": "尚未识别页面主讲SKU并核对其可成交性。",
                },
                "page_role": "unknown",
                ...
                "overall_diagnosis": {
                    "current_page_strategy": "",
                    "current_conversion_logic": "",
                    "current_core_purchase_reason": "",
                ...
                "detail_page_plan": {
                    "status": "stopped" if run_status == "stopped" else "unknown",
                    "strategy_summary": "",
                    "narrative_route": [],
                    "modules": [],
                    "asset_migration": [],
                    "boundary": "尚未完成详情页整体内容规划。",
                },
                "detail_page_assessment": {
                    "status": "stopped" if run_status == "stopped" else "insufficient_material",
                    "assessment_basis": "尚未完成细分类目购买任务链与五个买前判断的综合评估。",
                    "strengths": [],
                    "improvement_opportunities": [],
                    "boundary": "没有可读详情页时不推测优势或提升空间。",
                },
                "transaction_panel_plan": {
                    "status": "stopped" if run_status == "stopped" else "unknown",
                    "selection_area_mode": "unknown",
                    "platform_capability_status": "unknown",
                    "capability_summary": "尚未核对平台字段与品牌后台能力。",
                    "strategy_summary": "",
                    "selection_route": [],
                    "field_groups": [],
                    "fixed_information": [],
                    "dynamic_information": [],
                    "boundary": "尚未完成交易区选择方案。",
                },
