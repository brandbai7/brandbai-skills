...
() => {
  ...
  return {
    ...
    author_profile_url: authorMatch ? `https://www.xiaohongshu.com/user/profile/${authorMatch[1]}` : '',
...
def _collect_one_note(
    ...
    *,
    ...
    note = {
        ...
        "creator_snapshot": {
            "nickname": str(raw.get("author_name") or ""),
            "platform_account": "",
            "stable_creator_id": str(raw.get("author_platform_id") or ""),
            "profile_url": str(raw.get("author_profile_url") or ""),
            "bio": "",
            "followers": None,
            "total_likes": None,
            "snapshot_at": utc_now() if raw.get("author_name") or raw.get("author_platform_id") else "",
            "source": "current_note_detail",
        },
        "note_type": note_type,
