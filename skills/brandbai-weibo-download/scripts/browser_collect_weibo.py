...
def _collect_one_post(
    ...
    post = {
        ...
        "creator_snapshot": {
            ...
            "platform_account": uid,
            "stable_creator_id": uid,
            "profile_url": canonical_profile_url(uid) if uid else "",
            "bio": "",
            "followers": None,
            "total_likes": None,
            "snapshot_at": utc_now() if uid or raw.get("author_name") else "",
            "source": "current_post_detail",
        },
