...
| [`brandbai-product-value`](skills/brandbai-product-value/) | 0.1.22 | 从商品页、手卡、包装、参数、证据和用户资料建立可回溯事实；严格比较真实 P0 候选、保持单一核心价值轴，并拦截机械审计、缺席信息伪事实及无来源任务扩写 | Prototype · Noncommercial |
...
[在 WorkBuddy 安装 brandbai-product-value v0.1.22](https://www.codebuddy.cn/work/launch?skillname=brandbai-product-value&downloadurl=https%3A%2F%2Fgithub.com%2Fbrandbai7%2Fbrandbai-skills%2Freleases%2Fdownload%2Fbrandbai-product-value-v0.1.22%2Fbrandbai-product-value.zip&channelType=github)
