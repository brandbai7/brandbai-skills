...
| [`brandbai-product-page`](skills/brandbai-product-page/) | 0.6.4 | 以一核、两链、五问诊断商品页；主图逐张安排任务，交易区必查但只在影响选择时提出平台可实施方案，详情页按整页内容地图形成可执行改版建议；专业模式交付两份品牌可读文档 | Release candidate · Noncommercial |
...
[在 WorkBuddy 安装 brandbai-tiktok-download v0.2.3](https://www.codebuddy.cn/work/launch?skillname=brandbai-tiktok-download&downloadurl=https%3A%2F%2Fgithub.com%2Fbrandbai7%2Fbrandbai-skills%2Freleases%2Fdownload%2Fbrandbai-tiktok-download-v0.2.3%2Fbrandbai-tiktok-download.zip&channelType=github)
