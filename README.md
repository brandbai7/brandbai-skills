...
| [`brandbai-product-value`](skills/brandbai-product-value/) | 0.1.17 | 从商品页、手卡、包装、参数、证据和用户资料建立可回溯事实；保留原始 PDF 来源，拦截机械复核、摘要伪原文、重复或无依据 FABE，并生成干净普通版 | Prototype · Noncommercial |
...
[在 WorkBuddy 安装 brandbai-product-value v0.1.17](https://www.codebuddy.cn/work/launch?skillname=brandbai-product-value&downloadurl=https%3A%2F%2Fgithub.com%2Fbrandbai7%2Fbrandbai-skills%2Freleases%2Fdownload%2Fbrandbai-product-value-v0.1.17%2Fbrandbai-product-value.zip&channelType=github)
...
- [Product Value v0.1.17](https://github.com/brandbai7/brandbai-skills/releases/tag/brandbai-product-value-v0.1.17)
