...
| [`brandbai-product-value`](skills/brandbai-product-value/) | 0.1.16 | 从商品页、手卡、包装、参数、证据和用户资料建立可回溯事实；拦截循环审计时间、文件名伪证据、无来源比较和用户顾虑外推，并生成干净普通版 | Prototype · Noncommercial |
...
[在 WorkBuddy 安装 brandbai-product-value v0.1.16](https://www.codebuddy.cn/work/launch?skillname=brandbai-product-value&downloadurl=https%3A%2F%2Fgithub.com%2Fbrandbai7%2Fbrandbai-skills%2Freleases%2Fdownload%2Fbrandbai-product-value-v0.1.16%2Fbrandbai-product-value.zip&channelType=github)
...
- [Product Value v0.1.16](https://github.com/brandbai7/brandbai-skills/releases/tag/brandbai-product-value-v0.1.16)
